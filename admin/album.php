...
if(isset($_POST['add_album'])){
  ...
  // $album_music = $_FILES['standard-upload']['name'];
  // $album_tmp_music = $_FILES['standard-upload']['tmp_name'];
  // $sql_in = mysqli_query($conn,"INSERT INTO songs where song='$file' AND song_creator='$user'");
  // if($sql_in){
  //    echo 'great';
  // }
  // ............................album banner
...
// move_uploaded_file($album_tmp_music,"uploads/$album_music");
...
<div class="form-group">
  ...
  <div class="form-group">
  <input type="file" name="truce" id="truce">
  </div>
...
<div class="wrapper">
      <div class="upload-console">
        ...
        <div class="upload-console-body">
          ...
          <!-- <form action="up.php" method="POST" name="standard-upload" enctype="multipart/form-data"> -->
            <input
              ...
              multiple
            />
            <button id="standard-upload" type="submit" name="standard-upload">
              Upload
            </button>
          <!-- </form> -->

          <h3>Or drag and drop files below</h3>
          <div class="upload-console-drop" id="drop-zone" name="standard-upload">
          ...
          <div>
          <input type="text" placeholder="Please enter the song title here">
          
          <button type="submit" name="same">submit</button>
          </div>
          <div id="uploads-finished" name="standard-upload"  class="hidden">
