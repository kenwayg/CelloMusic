...
if (isset($_POST['action'])) {
 ...
 switch($action){
     case 'like':
        echo  '<script>
        alert("Track has been added to likes");
        </script>';
       ...
       break;
        case 'unlike':
            echo  "<script>
            alert('Track has been removed to likes');
            </script>";
...
global $conn;
$rating = array();
$likes_query = "SELECT COUNT(*)FROM music_rating where music_id = 
$music_id and rating_action='like' ";
